      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="bg-gray-900/60 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <h1 className="text-3xl font-bold text-white">PolÃ­tica de Privacidad</h1>
          </div>
          ...
          <div className="prose prose-invert prose-sky max-w-none space-y-8">
            ...
            <section className="bg-sky-500/10 border border-sky-500/20 rounded-2xl p-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                <strong>EliBot</strong> es una herramienta de automatizaciÃ³n diseÃ±ada exclusivamente para ayudar a responder mensajes en redes sociales mediante Inteligencia Artificial. Queremos ser absolutamente transparentes: <strong>no vendemos, no alquilamos y no comercializamos los datos personales ni los mensajes de tus clientes.</strong>
              </p>
            </section>

            <section>
              <h3 className="text-lg font-medium text-white mb-3">1. Uso de la InformaciÃ³n</h3>
              <p className="text-gray-400 leading-relaxed mb-4">
                La aplicaciÃ³n Ãºnicamente accede a los mensajes de Instagram (a travÃ©s de la API oficial de Meta) con el Ãºnico y exclusivo propÃ³sito de:
              </p>
              <ul className="list-disc pl-5 text-gray-400 space-y-2">
                <li>Leer el contenido del mensaje entrante.</li>
                <li>Procesar el contexto utilizando modelos de lenguaje (IA) para generar una respuesta Ãºtil.</li>
                <li>Enviar la respuesta automatizada de vuelta al usuario a travÃ©s de Instagram.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                Los mensajes procesados por EliBot se utilizan estrictamente en tiempo real para generar la respuesta pertinente. Los datos de las conversaciones y perfiles de los usuarios que interactÃºan con el bot estÃ¡n protegidos mediante cifrado y almacenados de manera segura exclusivamente para mantener el historial de la conversaciÃ³n necesario para que el bot tenga contexto, y para mostrar las analÃ­ticas privadas al dueÃ±o de la cuenta. <strong>Nadie mÃ¡s tiene acceso a estos datos.</strong>
              </p>
            </section>
            ...
            <section>
              <h3 className="text-lg font-medium text-white mb-3 flex items-center gap-2">
                ...
                3. InteracciÃ³n con Meta y Terceros
              </h3>
              <p className="text-gray-400 leading-relaxed">
                Cumplimos estrictamente con las polÃ­ticas para desarrolladores de Meta. La informaciÃ³n recibida a travÃ©s de webhooks no se comparte con redes de publicidad, corredores de datos ni ninguna otra entidad de terceros externa a los servicios de infraestructura en la nube necesarios para operar la aplicaciÃ³n (como nuestro proveedor de base de datos y procesamiento de IA).
              </p>
            </section>
            ...
            <section className="pt-6 border-t border-gray-800">
              <p className="text-sm text-gray-500">
                ...
                <br />
                Si tienes dudas sobre cÃ³mo procesamos los datos, puedes contactarnos a travÃ©s del administrador del sistema.
              </p>
            </section>
